...
class LibraryServiceController extends BaseController
{
     ...
     *
     * @param LibraryServiceRepository $repository
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function index(LibraryServiceRepository $repository)
    {
        $libraryServicesPagination = $repository
            ->getAllWithPagination(15);
        return view('admin.library-services.index',
