...
class PrintingPubhouseController extends BaseController
{
     ...
     *
     * @param PrintingPubhouseRepository $repository
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function index(PrintingPubhouseRepository $repository)
    {
        $pubhousesPagination = $repository->getAllWithPagination(15);
