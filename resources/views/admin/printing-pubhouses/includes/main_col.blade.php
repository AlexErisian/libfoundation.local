<div class="card">
    <div class="card-header bg-primary">
        <h5 class="text-white">Редагування запису: видавництво</h5>
    </div>
    <div class="card-body">
            ...
            <div id="addData" class="tab-pane" role="tabpanel">
                <div class="form-group">
                    ...
                    <textarea class="form-control"
                              id="notes"
                              name="notes"
                              rows="3">{{ old('notes', $pubhouse->notes) }}</textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="card-footer">
        ...
        <a class="btn btn-danger"
           href="{{ route('admin.printing-pubhouses.destroy', $pubhouse->id) }}">
            Видалити запис
        </a>
    </div>
</div>
